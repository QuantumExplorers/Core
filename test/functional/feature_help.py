...
"""Verify that starting quantum with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quantum with -h for help text")
        ...
        self.log.info("Start quantum with -version for version information")
        ...
        self.log.info("Start quantumd with -fakearg to make sure it does not start")
