...
bech32_templates = [
  ...
  ('qntm',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('qntm',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('qntm',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('qntm',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tqntm',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tqntm',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tqntm',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tqntm',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tqntm',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tqntm',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tqntm',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tqntm',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rqntm',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rqntm',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rqntm',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rqntm', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tqntm',   17, 32, Encoding.BECH32M, False, False, False),
  ('rqntm',  3,  1, Encoding.BECH32M, False, False, False),
  ('qntm',   15, 41, Encoding.BECH32M, False, False, False),
  ('tqntm',    0, 16, Encoding.BECH32,  False, False, False),
  ('rqntm',  0, 32, Encoding.BECH32,  True,  False, False),
  ('qntm',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tqntm',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rqntm',  0, 20, Encoding.BECH32,  False, False, True),
  ('qntm',    0, 20, Encoding.BECH32M, False, False, False),
  ('tqntm',    0, 32, Encoding.BECH32M, False, False, False),
  ('rqntm',  0, 20, Encoding.BECH32M, False, False, False),
  ('qntm',    1, 32, Encoding.BECH32,  False, False, False),
  ('tqntm',    2, 16, Encoding.BECH32,  False, False, False),
  ('rqntm', 16, 20, Encoding.BECH32,  False, False, False),
]
