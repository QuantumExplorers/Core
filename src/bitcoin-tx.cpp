...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " quantum-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  quantum-tx [options] <hex-tx> [commands]  Update hex-encoded quantum transaction\n" +
            "or:     quantum-tx [options] -create [commands]   Create hex-encoded quantum transaction\n" +
            "\n";
