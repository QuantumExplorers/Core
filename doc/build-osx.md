...
1. Clone the Quantum Core source code:
    ```shell
    git clone 
    cd quantum
    ```
...
2.  Build Quantum Core:
    ...
    Configure and build the headless Quantum Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Quantum Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Quantum"

touch "/Users/${USER}/Library/Application Support/Quantum/quantum.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Quantum/quantum.conf"
```

The first time you run quantumd, it will start downloading the blockchain. This process could
