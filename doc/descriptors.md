# Support for Output Descriptors in Quantum Core

Since Quantum Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `qntm1...` for mainnet or `tqntm1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Quantum Core wallets, a convenience function `combo` is
