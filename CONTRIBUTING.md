...
The Quantum Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Quantum Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/quantum-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to quantum-qt
...
The following applies to code changes to the Quantum Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Quantum
Network Protocol consensus changes.

Whether a pull request is merged into Quantum Core rests with the project merge
...
Patches that change Quantum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Quantum consensus, it must have been
